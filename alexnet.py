...
class AlexNet(object):
    ...
    def __init__(self, x, num_classes, skip_layer,
    ...
    def create(self):
        ...
        conv1 = conv(self.X, 11, 11, 96, 4, 4, name='conv1')
        norm1 = lrn(conv1, 2, 1e-05, 0.75, name='norm1')
        pool1 = max_pool(norm1, 3, 3, 2, 2, name='pool1')
        ...
        self.pool5 = max_pool(conv3, 3, 3, 2, 2, name='pool5')
